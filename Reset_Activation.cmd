...
::  IAS.cmd `:done` (atau `:done2` untuk reset) sekarang menahan jendela
::  dengan `cmd /k` saat unattended-non-silent, jadi pause di wrapper
::  redundant. Hanya pause kalau IAS.cmd return error supaya user lihat
::  pesan error.
if not "%ret%"=="0" (
